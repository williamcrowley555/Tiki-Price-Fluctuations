...
CREATE TABLE `comment` (
  ...
  `fullname` text CHARACTER SET utf8 COLLATE utf8_general_ci,
...
CREATE TABLE `timeline` (
  ...
  `explaination` text CHARACTER SET utf8 COLLATE utf8_general_ci,
...
-- Dump completed on 2021-11-24  8:26:38
